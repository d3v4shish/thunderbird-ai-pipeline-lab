...
|---|---|---|---|---|---|---|
| direct | 1.000 | 0.857 | 0.410 | 0.950 | 0.000 | 14.918 |
| hyde | 1.000 | 0.786 | 0.399 | 0.933 | 0.333 | 13.970 |
| fusion | 1.000 | 0.786 | 0.400 | 0.950 | 0.000 | 59.110 |
| decomposition | 0.800 | 0.810 | 0.371 | 0.800 | 0.000 | 43.268 |
| step_back | 1.000 | 0.857 | 0.410 | 0.950 | 0.000 | 30.317 |
| corrective | 0.700 | 0.214 | 0.214 | 0.800 | 1.000 | 830.192 |
| adaptive | 1.000 | 0.857 | 0.410 | 0.950 | 0.000 | 0.001 |
...
Transform calls: 65; cache hits: 0; failures: 3.
Corrective grade calls: 17; cache hits: 0; verdict accuracy: 0.647; label precision/recall: 0.529/0.713.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| direct | 1.000 | 0.857 | 0.410 | 0.950 | 0.963 | 0.000 | 1.000 | 14.918 |
| hyde | 1.000 | 0.786 | 0.399 | 0.933 | 0.950 | 0.333 | 1.000 | 13.970 |
| fusion | 1.000 | 0.786 | 0.400 | 0.950 | 0.963 | 0.000 | 1.000 | 59.110 |
| decomposition | 0.800 | 0.810 | 0.371 | 0.800 | 0.792 | 0.000 | 1.000 | 43.268 |
| step_back | 1.000 | 0.857 | 0.410 | 0.950 | 0.963 | 0.000 | 1.000 | 30.317 |
| corrective | 0.700 | 0.214 | 0.214 | 0.800 | 0.723 | 1.000 | 1.000 | 830.192 |
| adaptive | 1.000 | 0.857 | 0.410 | 0.950 | 0.963 | 0.000 | 1.000 | 0.001 |
...
- `graph-multihop`: facts 1.0, fact ranks `{"G02": 2}`, documents `["graph-team", "graph-vendor", "long-10240", "long-10240", "semantic-access", "meridian-schedule", "exact-distractor", "semantic-recovery"]`.
...
- `long-document-coverage`: facts 0.71875, fact ranks `{"F01": 2, "F02": 2, "F03": 2, "F04": 2, "F05": 4, "F06": 4, "F07": 4, "F11": 6, "F12": 6, "F13": 6, "F14": 5, "F15": 5, "F16": 5, "F17": 5, "F24": 8, "F25": 8, "F26": 8, "F27": 3, "F28": 3, "F29": 3, "F30": 1, "F31": 1, "F32": 1}`, documents `["long-10240", "long-10240", "long-10240", "long-10240", "long-10240", "long-10240", "exact-orbit", "long-10240"]`.
...
- `graph-multihop`: facts 1.0, fact ranks `{"G02": 2}`, documents `["graph-team", "graph-vendor", "meridian-schedule", "semantic-access", "semantic-recovery", "long-10240", "long-10240", "meridian-finance"]`.
- `multilingual`: facts 1.0, fact ranks `{"M01": 1}`, documents `["multilingual", "long-10240", "long-10240", "long-10240", "exact-distractor", "meridian-schedule", "long-10240", "long-10240"]`.
...
- `exact-identifier`: facts 0.0, fact ranks `{}`, documents `[]`.
- `long-document-coverage`: facts 0.8125, fact ranks `{"F01": 3, "F02": 3, "F03": 3, "F04": 3, "F05": 6, "F06": 6, "F07": 6, "F11": 4, "F12": 4, "F13": 4, "F14": 4, "F15": 7, "F16": 7, "F17": 7, "F18": 8, "F19": 8, "F20": 8, "F24": 5, "F25": 5, "F26": 5, "F27": 2, "F28": 2, "F29": 2, "F30": 1, "F31": 1, "F32": 1}`, documents `["long-10240", "long-10240", "long-10240", "long-10240", "long-10240", "long-10240", "long-10240", "long-10240"]`.
...
- `graph-multihop`: facts 1.0, fact ranks `{"G02": 3}`, documents `["graph-team", "long-10240", "graph-vendor", "exact-distractor", "semantic-access", "long-10240", "semantic-recovery", "meridian-finance"]`.
- `multilingual`: facts 1.0, fact ranks `{"M01": 1}`, documents `["multilingual", "long-10240", "long-10240", "long-10240", "exact-distractor", "meridian-schedule", "long-10240", "long-10240"]`.
- `prompt-injection`: facts 0.0, fact ranks `{}`, documents `[]`.
