...
- Complete: False
- Quality gate: False
- Fatal error: RelatedEmailRagError: context repeated instruction-like source text
- Records: 8/32 successful; 9 attempted

- Failed rel-invoice-05 / combined: RelatedEmailRagError: context repeated instruction-like source text
