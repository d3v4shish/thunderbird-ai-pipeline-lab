...
| 20K bounded map + host ledger | 3 | [1.0, 1.0, 1.0] | 33382 ms mean |
| Known-schema compaction | 3 | [1.0, 1.0, 1.0] | recorded per call |
| Targeted hybrid RAG | 3 x 3 probes | 0.000 pass rate | recorded per call |
| 8K-character page map | 1 diagnostic | 1.000 | 33269 ms |
| 30K-character page map | 1 diagnostic | 1.000 | 29780 ms |
| Rolling model state | 1 diagnostic | 0.000 | 36866 ms |
| Model hierarchical reduce | 1 diagnostic | 0.000 | 21859 ms |
