...
|---|---|---|---|---|---|---|---|---|---|
| direct | 0.970 | 0.846 | 0.547 | 0.038 | 0.231 | 1.000 | 1.000 | 61.298 | 1074.574 |
| selective | 1.000 | 1.000 | 0.562 | 0.038 | 0.231 | 1.000 | 1.000 | 62.259 | 1074.574 |
...
|---|---|---:|---:|---:|---:|:---:|:---:|
| `email-exact-room` | direct | 1.0 | 1.0 | 0.000 | 0.000 | False | False |
| `email-semantic-recovery` | direct | 1.0 | 1.0 | 0.000 | 0.000 | False | False |
| `email-latest-revision` | direct | 1.0 | 1.0 | 0.000 | 0.000 | False | False |
| `email-attachment` | direct | 1.0 | 1.0 | 0.000 | 0.000 | False | False |
| `email-prompt-injection` | direct | 1.0 | 1.0 | 1.000 | 1.000 | True | True |
| `email-multilingual` | direct | 1.0 | 1.0 | 0.000 | 0.000 | False | False |
| `email-multipart-meridian` | decomposition | 1.0 | 1.0 | 0.000 | 0.000 | False | False |
| `email-multipart-quartz` | decomposition | 1.0 | 1.0 | 0.000 | 0.000 | False | False |
| `email-multipart-ember` | decomposition | 1.0 | 1.0 | 0.000 | 0.000 | False | False |
| `email-multipart-polar` | decomposition | 1.0 | 1.0 | 0.000 | 0.000 | False | False |
| `email-exhaustive-atlas` | thread_range | 0.6666666666666666 | 1.0 | 0.000 | 0.000 | False | False |
