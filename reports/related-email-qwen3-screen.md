...
- Fixture digest: `0cc1f3097a7d693aac05fc358169bbf6a997415984c9948f155dc6d57c5518ba`
...
- Complete: False
- Quality gate: False
- Fatal error: RelatedEmailRagError: slot anchor must contain the value exactly once
- Records: 4/32 successful; 5 attempted

- Failed rel-invoice-04 / combined: RelatedEmailRagError: slot anchor must contain the value exactly once
