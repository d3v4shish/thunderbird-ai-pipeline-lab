...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| raw-local-lexical | raw | lexical | deterministic-local-v1 | 1.000 | 0.737 | 0.929 | 0.267 | 0.923 | 0.492 | 192512 | 17561 |
| raw-local-hybrid | raw | hybrid | deterministic-local-v1 | 1.000 | 0.763 | 0.929 | 0.326 | 0.920 | 0.793 | 192512 | 17561 |
| metadata-local-lexical | metadata | lexical | deterministic-local-v1 | 1.000 | 0.737 | 0.929 | 0.267 | 0.923 | 0.349 | 204800 | 19643 |
| metadata-local-hybrid | metadata | hybrid | deterministic-local-v1 | 0.929 | 0.737 | 0.929 | 0.311 | 0.892 | 1.264 | 204800 | 19643 |
| generated-local-lexical | generated | lexical | deterministic-local-v1 | 1.000 | 0.684 | 0.929 | 0.260 | 0.936 | 0.468 | 208896 | 22017 |
| generated-local-hybrid | generated | hybrid | deterministic-local-v1 | 0.929 | 0.737 | 1.000 | 0.354 | 0.945 | 1.505 | 208896 | 22017 |
| raw-endpoint-dense | raw | dense | qwen3-embedding:4b | 1.000 | 0.737 | 1.000 | 0.341 | 0.971 | 365.837 | 937984 | 17561 |
| raw-endpoint-hybrid | raw | hybrid | qwen3-embedding:4b | 1.000 | 0.816 | 1.000 | 0.348 | 1.000 | 402.919 | 937984 | 17561 |
| metadata-endpoint-dense | metadata | dense | qwen3-embedding:4b | 1.000 | 0.842 | 1.000 | 0.349 | 0.989 | 383.167 | 950272 | 19643 |
| metadata-endpoint-hybrid | metadata | hybrid | qwen3-embedding:4b | 1.000 | 0.816 | 1.000 | 0.348 | 1.000 | 384.853 | 950272 | 19643 |
| generated-endpoint-dense | generated | dense | qwen3-embedding:4b | 1.000 | 0.684 | 1.000 | 0.359 | 0.989 | 361.184 | 962560 | 22017 |
| generated-endpoint-hybrid | generated | hybrid | qwen3-embedding:4b | 1.000 | 0.711 | 1.000 | 0.342 | 1.000 | 355.010 | 962560 | 22017 |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| generated-vs-raw | local-lexical | +0.000 | -0.053 | +0.000 | -0.007 | +0.013 | -0.024 | +16384 | +4456 |
| generated-vs-raw | local-hybrid | -0.071 | -0.026 | +0.071 | +0.029 | +0.025 | +0.712 | +16384 | +4456 |
| generated-vs-raw | endpoint-dense | +0.000 | -0.053 | +0.000 | +0.018 | +0.018 | -4.653 | +24576 | +4456 |
| generated-vs-raw | endpoint-hybrid | +0.000 | -0.105 | +0.000 | -0.006 | +0.000 | -47.909 | +24576 | +4456 |
| generated-vs-metadata | local-lexical | +0.000 | -0.053 | +0.000 | -0.007 | +0.013 | +0.119 | +4096 | +2374 |
| generated-vs-metadata | local-hybrid | +0.000 | +0.000 | +0.071 | +0.044 | +0.053 | +0.241 | +4096 | +2374 |
| generated-vs-metadata | endpoint-dense | +0.000 | -0.158 | +0.000 | +0.010 | +0.000 | -21.983 | +12288 | +2374 |
| generated-vs-metadata | endpoint-hybrid | +0.000 | -0.105 | +0.000 | -0.006 | +0.000 | -29.842 | +12288 | +2374 |
...
| metadata-endpoint-dense | long-document-coverage | long-10240 | 27/32 | doc://long-10240#9157-10240; doc://long-10240#8141-9336; doc://long-10240#7120-8320; doc://long-10240#3044-4243; doc://long-10240#0-1194; doc://long-10240#1016-2215; doc://long-10240#5081-6280; doc://long-10240#2036-3222 |
...
| metadata-endpoint-dense | multilingual | multilingual, long-10240, exact-distractor, revision-old | 1/1 | doc://multilingual#0-90; doc://long-10240#2036-3222; doc://long-10240#5081-6280; doc://exact-distractor#0-87; doc://long-10240#9157-10240; doc://long-10240#0-1194; doc://revision-old#0-81; doc://long-10240#6101-7299 |
| metadata-endpoint-dense | prompt-injection | injection, contextual-thread, long-10240 | 1/1 | doc://injection#0-130; doc://contextual-thread#3045-3976; doc://long-10240#7120-8320; doc://contextual-thread#1017-2211; doc://long-10240#8141-9336; doc://contextual-thread#2032-3224; doc://long-10240#1016-2215; doc://long-10240#5081-6280 |
| metadata-endpoint-dense | scope-isolation | injection, long-10240, exact-distractor | 0/0 | doc://injection#0-130; doc://long-10240#7120-8320; doc://long-10240#1016-2215; doc://long-10240#8141-9336; doc://long-10240#4064-5260; doc://exact-distractor#0-87; doc://long-10240#3044-4243; doc://long-10240#5081-6280 |
...
| metadata-endpoint-hybrid | multilingual | multilingual, long-10240, exact-distractor, revision-old | 1/1 | doc://multilingual#0-90; doc://long-10240#2036-3222; doc://long-10240#5081-6280; doc://exact-distractor#0-87; doc://long-10240#9157-10240; doc://long-10240#0-1194; doc://revision-old#0-81; doc://long-10240#6101-7299 |
...
| metadata-endpoint-hybrid | scope-isolation | long-10240, injection | 0/0 | doc://long-10240#8141-9336; doc://long-10240#1016-2215; doc://long-10240#7120-8320; doc://long-10240#3044-4243; doc://injection#0-130; doc://long-10240#0-1194; doc://long-10240#5081-6280; doc://long-10240#4064-5260 |
| metadata-endpoint-hybrid | no-answer | exact-distractor, contextual-thread, revision-old, revision-latest, graph-vendor | 0/0 | doc://exact-distractor#0-87; doc://contextual-thread#0-1196; doc://contextual-thread#3045-3976; doc://revision-old#0-81; doc://revision-latest#0-99; doc://contextual-thread#1017-2211; doc://contextual-thread#2032-3224; doc://graph-vendor#0-75 |
